        ...
        <div>
          ...
          <div className="p-4 w-full rounded-t-xl border border-neutral-200 dark:border-neutral-600">
            ...
            <div className="flex justify-between items-center text-sm mt-4">
              ...
              <div>
                <div>
                  <button className="text-primary-500 text-sm font-medium py-2 px-4 rounded-lg transition-all hover:text-primary-600 focus:ring-4 focus:ring-blue-300 focus:text-primary-700 focus:outline-none">
                    &#171;
                  </button>
                  <button className="text-primary-500 text-sm font-medium py-2 px-4 rounded-lg transition-all hover:text-primary-600 focus:ring-4 focus:ring-blue-300 focus:text-primary-700 focus:outline-none">
                    &#8249;
