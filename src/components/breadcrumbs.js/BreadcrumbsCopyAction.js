...
import { defaultBreadcrumbs, slashBreadcrumbs, solidBgBreadcrumbs } from './BreadcrumbsCodeSnippets';
...
export const DefaultBreadcrumbsCopy = () => {
    ...
    return (
      <CopyToClipboard text={defaultBreadcrumbs} onCopy={onCopyDefaultBreadcrumbs}>
...
export const SolidBgBreadcrumbsCopy = () => {
    ...
    return (
      <CopyToClipboard text={solidBgBreadcrumbs} onCopy={onCopySolidBgBreadcrumbs}>
        <div className="hidden md:flex items-center">
