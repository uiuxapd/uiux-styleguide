          ...
          <div class="flex flex-col">
            <span class="token">
              ...
              <span class="attr-value">
                bg-primary-surface border-primary-border box-border flex w-full
                space-x-1 rounded-xl border p-1
              </span>
              <span class="punctuation">"</span>
              <span class="punctuation">{">"}</span>
              <br />
              ...
              <span class="punctuation">{">"}</span>
              <br />
              <span className="ml-8">Transaction</span>
              <br />
              <span class="punctuation ml-4">{"<"}</span>
              <span class="punctuation">{"/"}</span>
              <span class="tag">button</span>
...
export const RoundedTopTabCode = () => {
  return (
    <pre>
      <code lang="html">
        <div class="flex flex-col gap-4">
          <div class="flex flex-col">
            <span class="token">
              ...
              <span class="punctuation">"</span>
              <span class="attr-value">
                box-border flex w-full space-x-1 border-b border-neutral-300
              </span>
              <span class="punctuation">"</span>
              <span class="punctuation">{">"}</span>
              <br />
        ...
        <div class="flex flex-col gap-4">
          <div class="flex flex-col">
            <span class="token">
              ...
              <span class="punctuation">"</span>
              <span class="attr-value">
                flex w-full border-b border-neutral-300
              </span>
              <span class="punctuation">"</span>
              <span class="punctuation">{">"}</span>
              <br />
