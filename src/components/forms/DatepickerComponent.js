            ...
            <div className="component-section">
              <div className="flex justify-center w-full gap-4 flex-wrap">
                <div className="grow shrink-0 basis-1/2 md:basis-1/4">
                  ...
                  <input type="date" id="datepicker" name="datepicker" className="appearance-none block w-full py-2.5 px-4 text-base bg-white border border-slate-300 hover:border-primary-main rounded-lg leading-tight focus:outline-none focus:bg-white focus:ring focus:ring-primary-focused focus:border-primary-main" />
                </div>
                <div className="grow shrink-0 basis-1/2 md:basis-1/4">
                  <label htmlFor="datepickerdisable" className="capitalize text-slate-700">
                    datepicker disable
                  </label>
                  <input type="date" id="datepickerdisable" name="datepickerdisable" className="block w-full py-2.5 px-4 text-base text-slate-500 bg-slate-200 border border-slate-300 hover:border-slate-300 rounded-lg leading-tight focus:outline-none focus:bg-white focus:ring focus:ring-primary-focused focus:border-primary-main" disabled />
                </div>
                <div className="grow shrink-0 basis-1/2 md:basis-1/4">
                  <label htmlFor="datepickererror" className="capitalize text-slate-700">
                    datepicker error
                  </label>
                  <input type="date" id="datepickererror" name="datepickererror" className="block w-full py-2.5 px-4 text-base text-error-main bg-error-surface border border-error-border hover:border-error-main rounded-lg leading-tight focus:outline-none focus:bg-error-surface focus:ring focus:ring-error-focused focus:border-error-main" />
